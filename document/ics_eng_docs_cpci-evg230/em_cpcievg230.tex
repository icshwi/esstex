...
\SetWatermarkText{\textbf{Obsolete}}
...
\begin{figure}[!htb]
  \centering
  \includegraphics[width=0.99\textwidth]{./pictures/mrf_cpci_evg230.png}
  \caption{
    MRF cPCI-EVG-230.
  }
